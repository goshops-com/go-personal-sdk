const AudioSearch=function(){let e,a,o,i,r,n={};function s(e){return e.replace(/[^a-zA-Z0-9 ]/g,"")}async function t(s){let t=document.getElementById("gopersonal-audio-search-voiceMicContainer");if(o)a.stop();else{r&&clearTimeout(r),r=setTimeout(function(){o&&t.click()},5e3),t.querySelector(".gopersonal-audio-search-circle").classList.add("gopersonal-audio-search-active");try{let c=await navigator.mediaDevices.getUserMedia({audio:!0});a=new MediaRecorder(c),i=[],a.ondataavailable=e=>{i.push(e.data)},a.onstop=async()=>{t.querySelector(".gopersonal-audio-search-circle").classList.remove("gopersonal-audio-search-active"),t.querySelector(".gopersonal-audio-search-circle svg").classList.add("gopersonal-audio-search-fa-spin");let a=new Blob(i,{type:"audio/wav"}),r=new File([a],"grabacion_audio.wav",{type:"audio/wav"}),c=new FormData;c.append("file",r);try{let l={type:"voice",...n},d=await window.gsSDK.voiceSearch(c,l);["\xa1Gracias por ver!","Subt\xedtulos realizados por la comunidad de Amara.org","Subtitulado por la comunidad de Amara.org","Subt\xedtulos por la comunidad de Amara.org","Subt\xedtulos creados por la comunidad de Amara.org","Subt\xedtulos en espa\xf1ol de Amara.org","Subt\xedtulos hechos por la comunidad de Amara.org","Subtitulos por la comunidad de Amara.org","M\xe1s informaci\xf3n www.alimmenta.com","www.mooji.org",].includes(d.query.trim())&&(d.query=void 0),s(d)}catch(p){console.error("Error during voice search:",p),s(null,p)}o=!1,e.style.display="none",t.querySelector(".gopersonal-audio-search-circle svg").classList.remove("gopersonal-audio-search-fa-spin")},a.start(1e3),o=!0}catch(l){console.error("Error accessing microphone:",l),t.querySelector(".gopersonal-audio-search-circle").classList.remove("gopersonal-audio-search-active"),s(null,l)}}}return{open:function(a={},i){e?n={...n,...a}:function a(i={}){n={...i},(e=document.createElement("div")).id="gopersonal-audio-search-voiceSearchOverlay",e.style.display="none",e.innerHTML=`
